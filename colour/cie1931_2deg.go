...
func Cie_x(lambda float32) float32 {
	...
	bin := int(((lambda - cie1931_LAMBDAMIN) / (cie1931_LAMBDAMAX - cie1931_LAMBDAMIN)) * float32(len(x_bar)))
...
func Cie_y(lambda float32) float32 {
	...
	bin := int(((lambda - cie1931_LAMBDAMIN) / (cie1931_LAMBDAMAX - cie1931_LAMBDAMIN)) * float32(len(y_bar)))
...
func Cie_z(lambda float32) float32 {
	...
	bin := int(((lambda - cie1931_LAMBDAMIN) / (cie1931_LAMBDAMAX - cie1931_LAMBDAMIN)) * float32(len(z_bar)))
